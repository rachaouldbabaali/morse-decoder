...
# 🎯 Morice DECODER<a name="about-project"></a>

> In this project, we have implemented a ruby function that decode morise code
>
...
```bash
  git clone https://github.com/rachaouldbabaali/morise-decoder.git
```
...
- [ ] **[Add a function that code a phrase with Morise code]**
...
Feel free to check the [issues page](https://github.com/rachaouldbabaali/morise-decoder/issues).
